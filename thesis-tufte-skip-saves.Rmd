...
date: "Documentation last updated on Oct 16, 2017"
output: 
  tufte::tufte_handout
---
# Intro
...
This notebook differs from the other (`thesis.Rmd`) in that graphics here have been revised to reflect simpler, cleaner styles. Additionally, this file doesn't include plot-to-image save instructions, meaning that it can be knit into a document more quickly.
...
```{r loads-by-fractions, fig.height=8, fig.width=5}
